...
(async () => {
  ...
  await fs.writeFile("peptic-ulcer-disease-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("peptic-ulcer-disease-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
